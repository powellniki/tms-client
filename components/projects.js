    ...
    return (
        <section className="text-center mt-32 mb-32">
            ...
            <div className="flex flex-col lg:flex-row px-2 lg:px-4 text-center">
                ...
                <div className="w-full lg:w-1/3 lg:m-1 bg-gray-100 p-2 md:mb-8 mb-0">
                    <div className="w-full">
                        <div className="bg-gray-300 p-2 h-48 md:h-80 lg:h-80 flex items-center justify-center">
                            image placeholder
                        </div>
                    </div>
                    ...
                    <p className="text-tms-red text-left underline">Read More</p>
                </div>
