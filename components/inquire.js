...
export default function Inquire() {
    ...
    return (
        <div className="bg-tms-gray text-center mt-32 py-28 px-4 md:px-0">
            <div ref={inquireRef}>
                <h2 className="font-heading md:w-2/3 lg:w-1/2 mx-auto text-tms-white text-3xl lg:text-4xl tracking-wider text-shadow-sm uppercase">explore the possibilities for your upcoming building project</h2>
                {/* <h3 className="font-heading text-tms-white text-xl lg:text-2xl mt-14 uppercase tracking-wider"></h3> */}
                <p className="text-tms-white font-Roboto font-light text-shadow-sm text-lg md:text-xl text-center mx-auto mt-6 md:w-2/3 lg:w-1/2">
                ...
                <button 
                    ...
                    className="uppercase font-heading text-[25px] bg-tms-yellow text-white text-shadow-sm py-2 w-48 hover:bg-tms-black hover:text-tms-white mt-6 lg:mt-8"
                >
                    <span className="tracking-wider">Inquire</span>
                </button>
            </div>
        </div>
    )
