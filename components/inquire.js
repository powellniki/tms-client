    ...
    return (
        <div className="p-8 text-center mt-32 mb-28">
            ...
            <button 
                ...
                className="mt-8 py-1 px-8 bg-tms-yellow border border-tms-yellow text-tms-white hover:bg-white hover:text-tms-black hover:border-tms-white font-heading text-xl font-bold text-shadow-sm hover:text-shadow-none"
            >
                INQUIRE
            </button>
        </div>
