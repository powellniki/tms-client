...
export default function OurImpact() {
    ...
    return (
        <section className="bg-tms-gray flex flex-col lg:flex-row">
            ...
            <div className="flex flex-col w-full lg:w-1/2 items-center justify-center mt-12 mb-12 lg:m-0 ">
                ...
                <p className="text-white text-md md:text-xl text-center pt-4 pl-6 pr-6 md:pt-8 md:pl-12 md:pr-12 lg:pr-20 lg:pl-20 lg:pt-8 text-shadow-lg">
