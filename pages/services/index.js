...
export default function Services() {
    return (
        <article className="mt-16 md:mt-20 lg:mt-24 mb-32">
            <h1 className="w-screen font-heading text-tms-red text-5xl xl:text-6xl text-shadow-lg text-center md:mb-8">OUR SERVICES</h1>
            ...
            <section className="w-screen flex flex-col lg:flex-row mt-12 p-2 md:p-4 md:mt-2 lg:p-8">
                ...
                <div className="lg:w-1/2 w-full mt-4 p-4 lg:mt-16 lg:pl-8">
                    <h1 className="text-gray-800 font-heading text-4xl xl:text-5xl md:leading-snug text-shadow-lg mb-4 lg:mb-8">PRE-CONSTRUCTION</h1>
                    <p className="text-gray-800 text-md lg:text-lg pr-4">
            ...
            <section className="w-screen flex flex-col lg:flex-row-reverse mt-12 p-2 md:p-4 md:mt-2 lg:p-8">
                ...
                <div className="lg:w-1/2 w-full mt-4 p-4 lg:mt-16 lg:pr-8 lg:text-end">
                    <h1 className="text-gray-800 font-heading text-4xl xl:text-5xl md:leading-snug text-shadow-lg mb-4 lg:mb-8">GENERAL CONTRACTING</h1>
            ...
            <section className="w-screen flex flex-col lg:flex-row mt-12 p-2 md:p-4 md:mt-2 lg:p-8">
                ...
                <div className="lg:w-1/2 w-full mt-4 p-4 lg:mt-16 lg:pl-8">
                    <h1 className="text-gray-800 font-heading text-4xl xl:text-5xl md:leading-snug text-shadow-lg mb-4 lg:mb-8">DESIGN-BUILD</h1>
                    <p className="text-gray-800 text-md lg:text-lg pr-4">
            ...
            <section className="w-screen flex flex-col lg:flex-row-reverse mt-12 p-2 md:p-4 md:mt-2 lg:p-8">
                ...
                <div className="lg:w-1/2 w-full mt-4 p-4 lg:mt-16 lg:pr-8 lg:text-end">
                    <h1 className="text-gray-800 font-heading text-4xl xl:text-5xl md:leading-snug text-shadow-lg mb-4 lg:mb-8">PROGRAM MANAGEMENT</h1>
                    <p className="text-gray-800 text-md lg:text-lg">
