    ...
    return (
        <article className="w-[100vw] pb-16">
            ...
            <div ref={serviceHeaderRef} className="flex flex-col items-center text-center px-10 md:px-12 lg:px-12 py-12 lg:pt-20">
                ...
                <h2 className="font-heading w-2/3 lg:w-1/2 text-tms-black text-xl lg:text-2xl mt-12 uppercase tracking-wider">
                ...
                <p className="text-tms-black w-2/3 lg:w-1/2 font-Roboto font-light text-md md:text-lg mt-4">Whether you need pre-construction planning, design-build expertise, or program management, our experienced team is dedicated to delivering exceptional results. With a focus on quality, communication, and efficiency, we tailor our services to meet the unique needs of every client and project.</p>
            </div>
