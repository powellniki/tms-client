...
export default function Inquiry() {
    return (
        <main className="w-screen">
            <div className="flex flex-col lg:flex-row p-4 mt-2 mb-12 md:mt-4 md:mb-24 lg:px-8">

                <div className="w-full lg:w-1/2 h-[36rem] lg:h-[42rem] overflow-hidden relative">
                    <Image 
                        src={inquiryImage} 
